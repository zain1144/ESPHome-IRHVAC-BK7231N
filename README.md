...
تُفحص الالتقاطات التي يطابق حجمها إطار Kelvinator مبكرًا مع تحقق صارم من
التذييل وchecksum. وإذا ظهرت نتيجة `UNKNOWN` لهذا الحجم، تعاد محاولة
Kelvinator وحده بسماحية `65%`، بينما تبقى بقية البروتوكولات على القيمة
المحددة. كما تبدأ مهلة منع التكرار بعد انتهاء فك الإطار حتى لا يُنشر نصف
إطار شبيه بـGree بعد إطار Kelvinator صحيح.
